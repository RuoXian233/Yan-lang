        ...
        if sys.argv[2] == '-linux':
            with open('build.sh', 'w') as f:
                ...
                for index, module in enumerate(MODULES):
                    ...
                    f.write(f'echo \'  {CC_LINUX} -std={CXX_STANDARD} {DEBUG} yan-lib{module}.cpp {FLAGS_LIBS} -o yan-{module}.so\'\n')
                    f.write(f'{CC_LINUX} -std={CXX_STANDARD} {DEBUG} yan-lib{module}.cpp {FLAGS_LIBS} -o yan-{module}.so\n')
            ...
            with open('build-win32.sh', 'w') as f:
                ...
                for index, module in enumerate(MODULES):
                    ...
                    f.write(f'echo \'  {CC_WIN32} -std={CXX_STANDARD} {DEBUG} yan-lib{module}.cpp {FLAGS_LIBS_WIN32} -o yan-{module}.dll\'\n')
                    f.write(f'{CC_WIN32} -std={CXX_STANDARD} {DEBUG} yan-lib{module}.cpp {FLAGS_LIBS_WIN32} -o yan-{module}.dll\n')
