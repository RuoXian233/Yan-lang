...
echo 'Building library "rand" ... (2 / 7) -> yan-rand.so'
...
echo 'Building library "fs" ... (3 / 7) -> yan-fs.so'
...
echo 'Building library "string" ... (4 / 7) -> yan-string.so'
...
echo 'Building library "inspect" ... (5 / 7) -> yan-inspect.so'
...
echo 'Building library "os" ... (6 / 7) -> yan-os.so'
...
echo 'Building library "time" ... (7 / 7) -> yan-time.so'
